...
if len(sys.argv) == 1:
    event1, values1 = sg.Window('Максимальний потік',
                    [[sg.Text('Оберіть файл')],
                    [sg.In(), sg.FileBrowse('Огляд')],
...
print ("Максимальний можливий потік становить: %d " % g.FordFulkerson(source, sink))
